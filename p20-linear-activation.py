...
for epoch in range(10001):
    ...
    #Accuracy
    predictions_values = activation2.output
    accuracy = np.mean(np.absolute(predictions_values - y) < accuracy_precision)
...
print(f"validation, acc: {accuracy:.3f}, loss: {loss:.6f}")
